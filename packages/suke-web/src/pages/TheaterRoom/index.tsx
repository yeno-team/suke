    ...
    return (
        <div className="bg-spaceblack overflow-hidden flex flex-col lg:h-screen lg:block channel_elements lg:overflow-hidden lg:relative lg:mt-17 lg:mr-96">
            ...
            { 
                ...
                <div className="w-full bg-coolblack h-9/10 flex justify-center items-center text-white">{roomData != null && roomData.startedAt <= 0 ? 'The theater will start shortly! ' : 'This Schedule does not exist or has ended.'}</div>
            }
